...
from sentio.repositories.tenants import TenantRepository, LocationRepository, TenantUserRepository
from sentio.models.tenant import Tenant, Location
from sentio.schemas.tenant import TenantCreateWithLocation, TenantUpdate, LocationCreate, LocationUpdate, \
...
class TenantService:
    ...
    async def create_tenant_with_default_location(
          self,
          data: TenantCreateWithLocation
    ) -> Tenant:
