...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("phone", sa.String(length=32), nullable=True),
        sa.Column(
            "plan", sa.Enum("LITE", "STANDARD", "PRO", name="tenants_plan_enum"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_tenant_customers_tenant_id"), "tenant_customers", ["tenant_id"], unique=False
    )
    op.create_table(
        "services",
        sa.Column("name", sa.String(length=255), nullable=False),
    ...
    op.create_index(
        op.f("ix_staff_members_tenant_id"), "staff_members", ["tenant_id"], unique=False
    )
    op.create_table(
        "tenant_users",
        sa.Column("location_id", sa.BigInteger(), nullable=True),
        ...
        sa.Column(
            "role",
            sa.Enum("OWNER", "ADMIN", "MANAGER", "STAFF", name="tenant_user_role_enum"),
            nullable=False,
        ),
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column("tenant_id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_staff_services_tenant_id"), "staff_services", ["tenant_id"], unique=False
    )
    op.create_table(
        "work_schedules",
        sa.Column("staff_member_id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_work_schedules_tenant_id"), "work_schedules", ["tenant_id"], unique=False
    )
    op.create_table(
        "time_slots",
        sa.Column("staff_member_id", sa.BigInteger(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("AVAILABLE", "BLOCKED", "BOOKED", "EXPIRED", name="timeslot_status_enum"),
            nullable=False,
        ),
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column("tenant_id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        "ix_time_slots_tenant_start", "time_slots", ["tenant_id", "start_at"], unique=False
    )
    op.create_table(
        "bookings",
        sa.Column("customer_id", sa.BigInteger(), nullable=False),
